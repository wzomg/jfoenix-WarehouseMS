...
public class EmpLook {
    ...
    public EmpLook(SimpleIntegerProperty goodid, SimpleStringProperty goodname, SimpleStringProperty goodShelfid, SimpleIntegerProperty goodTotal, SimpleDoubleProperty goodPrice) {
        this.goodid = goodid;
